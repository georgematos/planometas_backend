...
import br.com.zipext.plr.service.AvaliacaoProjetoOrcService;

@Controller
@RequestMapping("/avalorcamento")
public class AvaliacaoProjetoOrcController {
	
	@Autowired
	private AvaliacaoProjetoOrcService service;
