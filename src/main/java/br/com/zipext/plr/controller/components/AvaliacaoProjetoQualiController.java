...
import br.com.zipext.plr.service.AvaliacaoProjetoQualiService;

@Controller
@RequestMapping("/avalquali")
public class AvaliacaoProjetoQualiController {
	
	@Autowired
	private AvaliacaoProjetoQualiService service;
