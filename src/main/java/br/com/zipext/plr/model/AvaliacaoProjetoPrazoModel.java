...
@Entity
@Table(schema = "METAS", name = "CAD_AVAL_META_REL_PRAZO")
public class AvaliacaoProjetoPrazoModel {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqAvalMetaPrazo")
	@SequenceGenerator(schema = "METAS", name = "seqAvalMetaPrazo", sequenceName = "CD_AVAL_META_PRAZO_SEQ", initialValue = 1000)
	@Column(name = "CD_AVAL_META_PRAZO")
	private Long id;
	
	@Column(name = "DS_AVAL_META_PRAZO")
    ...
    @OneToMany(mappedBy = "pk.avaliacaoProjetoPrazo")
    public List<RelAvaliacaoProjetoModel> avaliacoesProjeto;
    
    public AvaliacaoProjetoPrazoModel() {}
    
    public AvaliacaoProjetoPrazoModel(Long id) {
    	this.id = id;
    }
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AvaliacaoProjetoPrazoModel other = (AvaliacaoProjetoPrazoModel) obj;
		if (descricao == null) {
